...
class PreParser(ast.NodeVisitor, ErrorThrower):
    ...
    def __init__(self, comp_data: CompData, code_gen: CodeGen):
        super().__init__()
        self.__data: CompData = comp_data
        self.__current_class: _class.LangClass = None
        self.__current_file: LangFile = None
